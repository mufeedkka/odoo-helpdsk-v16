...
class TicketPortal(portal.CustomerPortal):
    ...
    @http.route(['/my/tickets/<int:id>'], type='http', auth="public", website=True)
    def portal_tickets_details(self, id):
        ...
        return request.render("odoo_website_helpdesk.portal_ticket_details", data)
...
class WebsiteDesk(http.Controller):
    ...
    @http.route(['/rating/<int:ticket_id>'], type='http', auth="public", website=True,
                sitemap=True)
